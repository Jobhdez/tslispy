...
export class SchemeLexer extends Lexer {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(SchemeLexer._LITERAL_NAMES, SchemeLexer._SYMBOLIC_NAMES, []);
	...
	// @Override
	public get ruleNames(): string[] { return SchemeLexer.ruleNames; }

	// @Override
	public get serializedATN(): string { return SchemeLexer._serializedATN; }

	// @Override
	public get channelNames(): string[] { return SchemeLexer.channelNames; }

	// @Override
	public get modeNames(): string[] { return SchemeLexer.modeNames; }

	public static readonly _serializedATN: string =
		"\x03\uC91D\uCABA\u058D\uAFBA\u4F53\u0607\uEA8B\uC241\x02\x19\x9E\b\x01" +
	...
	public static get _ATN(): ATN {
		if (!SchemeLexer.__ATN) {
			SchemeLexer.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(SchemeLexer._serializedATN));
		}
